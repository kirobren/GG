...
class NotifOrgScreen extends StatefulWidget {
const NotifOrgScreen({super.key});

@override
State<NotifOrgScreen> createState() => _NotifOrgScreenState();
}

class _NotifOrgScreenState extends State<NotifOrgScreen> {
